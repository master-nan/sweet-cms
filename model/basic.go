...
type Basic struct {
	...
	GmtCreate     CustomTime     `gorm:"type:datetime;autoCreateTime" json:"gmtCreate"`
	GmtCreateUser *int           `json:"gmtCreateUser"`
	GmtModify     CustomTime     `gorm:"type:datetime;autoCreateTime;autoUpdateTime" json:"gmtModify"`
	GmtModifyUser *int           `json:"gmtModifyUser"`
